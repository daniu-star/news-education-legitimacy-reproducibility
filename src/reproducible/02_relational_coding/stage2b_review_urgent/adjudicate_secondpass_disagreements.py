...
OUT=Path(os.environ['NEWS_EDU_ROOT']) / '02_relational_coding' / 'stage2b_review_urgent'
R1=pd.read_csv(OUT/'urgent_525_agent_adjudicated_round1.csv',low_memory=False)
B=pd.read_csv(OUT/'urgent_525_secondpass_blind_input.csv',low_memory=False)
C=pd.read_csv(OUT/'urgent_525_secondpass_comparison.csv',low_memory=False)
S2=pd.read_csv(OUT/'urgent_525_secondpass_blind_results.csv',low_memory=False)
...
f.to_csv(OUT/'urgent_525_secondpass_final_adjudication.csv',index=False,encoding='utf-8-sig')
...
allf.to_csv(OUT/'urgent_outstanding_493_agent_final.csv',index=False,encoding='utf-8-sig')
# change log
...
with open(OUT/'urgent_outstanding_493_final_summary.json','w',encoding='utf-8') as fh:json.dump(summary,fh,ensure_ascii=False,indent=2)
