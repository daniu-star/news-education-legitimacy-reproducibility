...
BLIND=OUT/'urgent_525_secondpass_blind_input.csv'
KEY=OUT/'urgent_525_secondpass_round1_key.csv'
R1=OUT/'urgent_525_agent_adjudicated_round1.csv'
...
s=pd.DataFrame(rows)
s.to_csv(OUT/'urgent_525_secondpass_blind_results.csv',index=False,encoding='utf-8-sig')
...
cmp.to_csv(OUT/'urgent_525_secondpass_comparison.csv',index=False,encoding='utf-8-sig')
...
with open(OUT/'urgent_525_secondpass_agreement_metrics.json','w',encoding='utf-8') as f:json.dump(metrics,f,ensure_ascii=False,indent=2)
